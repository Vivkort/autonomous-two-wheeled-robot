...
| NVMe SSD 256 GB (M.2 2280) | OS + storage | $30 | [NO] | Jetson boots better from SSD than SD |
| Slamtec RPLidar C1 | 360 deg 2D lidar (SLAM) | $100 | [YES] | USB via included serial adapter |
| Luxonis OAK-D Lite | Depth camera (3D obstacles + future AI) | $220 | [YES] | USB 3.0; on-camera AI |
| 2x DC gear motors w/ quadrature encoders | Drive + odometry | $30 | [YES] | ENCODERS REQUIRED |
| TB6612FNG motor driver | Dual H-bridge amplifier | $8 | [YES] | Prefer over L298N |
| ESP32 dev board | Real-time motor/encoder MCU | $10 | [YES] | Runs micro-ROS |
| BNO055 IMU | Orientation / sensor fusion | $25 | [YES] | On-chip fusion; I2C. Skippable if using RealSense IMU |
| 3S LiPo battery + charger | Power | $45 | [ ] | Or 12V pack |
| Buck converter 5V / 5A | Clean power for the Jetson | $10 | [YES] | Dedicated rail, not shared with motors |
| Caster wheel + drive wheels/hubs | Rolling | $15 | [YES WHEELS NO CASTER] | |
